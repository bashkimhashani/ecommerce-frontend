...
<template>
  ...
  >
    ...
    <div v-else-if="product" class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      <div class="min-w-0">
        <div
          class="overflow-hidden rounded-md border border-slate-200 bg-slate-100 dark:border-slate-700 dark:bg-slate-900"
        >
          <img
            v-if="selectedImage"
          ...
          <div
            v-else
            class="flex aspect-[4/3] items-center justify-center px-6 text-center text-sm font-medium text-slate-400 dark:text-slate-300"
          >
            {{ product.name }}
          </div>
        </div>
        ...
        <div
          class="mt-6 rounded-md border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900"
        >
          <div class="flex border-b border-slate-200 dark:border-slate-700">
            <button
              ...
              :class="
                activeTab === 'specs'
                  ? 'border-b-2 border-slate-900 text-slate-950 dark:border-slate-100 dark:text-white'
      ...
      <aside
        class="h-fit rounded-md border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-900"
      >
        ...
        <div class="mt-5 flex items-end justify-between gap-4">
          ...
          <p
            class="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-200"
          >
            {{ totalStock }} in stock
          </p>
        </div>
        ...
        <p
          ...
          class="mt-3 rounded-md bg-emerald-50 px-3 py-2 text-sm font-medium text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-200"
        >
          {{ addToCartStatus }}
        </p>
      </aside>
