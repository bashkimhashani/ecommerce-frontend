...
<template>
  <header
    class="border-b border-neutral-200 bg-white/95 backdrop-blur transition-colors duration-300 dark:border-slate-800 dark:bg-slate-950/95"
  >
    <div class="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 lg:flex-row lg:items-center">
      ...
      <div class="flex w-full flex-col gap-3 sm:flex-row sm:items-center lg:w-auto">
        ...
        <div
          class="inline-flex rounded-md border border-slate-200 bg-slate-50 p-1.5 dark:border-slate-700 dark:bg-slate-900"
        >
          <!-- Catalog -->
          <button
            type="button"
          ...
          <button
            ...
            :class="
              activeView === 'profile'
                ...
                : 'border-slate-300 bg-white text-slate-700 hover:border-slate-950 hover:text-slate-950 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-slate-200 dark:hover:text-white'
            "
