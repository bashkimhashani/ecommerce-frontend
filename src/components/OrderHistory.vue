  ...
  <section class="mx-auto max-w-6xl px-5 py-8" aria-labelledby="orders-title">
    <div class="mb-6 flex flex-col gap-4 border-b border-neutral-200 pb-5 sm:flex-row sm:items-end sm:justify-between">
      <div>
        ...
        <h1 id="orders-title" class="mt-2 text-3xl font-bold text-neutral-950">
          Your orders
        </h1>
      </div>
    ...
    <div class="overflow-x-auto" aria-label="Order status filters">
      <div class="flex min-w-max gap-2">
        <button
          ...
          :class="activeStatus === tab.id ? 'border-neutral-950 bg-neutral-950 text-white' : 'border-neutral-200 bg-white text-neutral-600 hover:border-neutral-300 hover:text-neutral-950'"
          type="button"
        ...
        >
          ...
          <span
            ...
            :class="activeStatus === tab.id ? 'bg-white/15 text-white' : 'bg-neutral-100 text-neutral-500'"
          >
    ...
    <div v-else-if="!errorMessage && !filteredOrders.length" class="mt-8 border-y border-neutral-200 py-12 text-center">
